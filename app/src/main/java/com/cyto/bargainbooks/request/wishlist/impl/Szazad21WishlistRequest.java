...
public class Szazad21WishlistRequest implements WishlistRequest {
    ...
    /**
     * Creates a new instance of Szazad21WishlistRequest
     *
     ...
     */
    public Szazad21WishlistRequest(@NotNull Context context, ListRequestHandler listHandler, @NotNull BookHandler bh, ErrorHandler eh) {
